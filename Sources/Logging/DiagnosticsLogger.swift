...
public final class DiagnosticsLogger {
    ...
    private lazy var logFileLocation: URL = FileManager.default.documentsDirectory.appendingPathComponent("diagnostics_log_4.txt")
    ...
    private let maximumSize: ByteCountFormatter.Units.Bytes = 4 * 1024 * 1024 // 6 MB
